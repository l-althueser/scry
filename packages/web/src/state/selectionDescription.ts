export type CompositionCounts = { instances: number; pipes: number; shapes: number; leaderLines: number }

/**
 * "2 instances, 1 pipe" style summary of a selection's composition across
 * all four kinds — shared by the status bar and the properties panel's
